...
It seems like the best alternative would be to take the touchback, and yet about 20% of kickoffs that reach the endzone are returned out of the endzone by the receiving team! Returning a kickoff from the endzone, instead of taking a touchback, results in several disadvantages for the receiving team:

* worse starting field position
* lower EPA
* higher chance of turnover occurring

![](https://raw.githubusercontent.com/brndngrhm/big-data-bowl/main/img/kickoff_bar.svg?token=ADFAP2MKGO4JDQ2RQACSSBLBZTQXA)
