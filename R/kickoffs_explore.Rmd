...
kickoffs %>%
  ...
  labs(x = "", y = "Count", title = "Endzone returns are somewhat consistent across seasons",
       subtitle = "About 19% of Endzone Kickoffs are Returned out of the Endzone", align = 'left')
```
...
yardline <- 
  ...
  labs(x = "", y = "\nDrive Starting Yardline",
       title = "Running a kickoff out of the endzone tends to put the recieving team at a disadvantage, and results in a lower EPA\n")
